...
def famtemplate (request):
    fran = Familiar (nombre = "Francisco", relacion = "Hermano", genero = "Masculino" , edad = 24, nacimiento = datetime(1998,3,10))
    mama = Familiar (nombre = "Silvia", relacion = "Mama", genero = "Femenino" , edad = 65, nacimiento = datetime(1957,5,14))
    gasty = Familiar (nombre = "Gasty", relacion = "Perro", genero = "Masculino" , edad = 14, nacimiento =  datetime(2008,8,8))
    fran.save()
    mama.save()
    gasty.save()
